SET IDENTITY_INSERT Lojamix.dbo.tipo_documento_financeiro ON
...
SET IDENTITY_INSERT Lojamix.dbo.documento_receber ON
...
UPDATE Hiper.dbo.documento_pagar SET NUMERO_DOCUMENTO_PAGAR = ID_DOCUMENTO_PAGAR 
WHERE NUMERO_DOCUMENTO_PAGAR in(select numero_documento_pagar from hiper.dbo.documento_pagar group by numero_documento_pagar having COUNT(numero_documento_pagar)>1)

SET IDENTITY_INSERT Lojamix.dbo.documento_pagar ON
...
UPDATE Lojamix.dbo.centro_custo 
